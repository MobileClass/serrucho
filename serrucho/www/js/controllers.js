...
.controller('DashCtrl', function($scope, offers, users) {
	offers.getItems().success(function (results) {
            console.log(results);
        }).error(function (err) {
        });
	
	users.getItems().success(function (results) {
            console.log(results);
        }).error(function (err) {
        });
})
...
.controller('AllRestCtrl', function($scope, $ionicModal, allRest) {
  ...
  $scope.openModal = function(id) {
	...
	$scope.items = allRest.getItem(id);
    $scope.modal.show();
  };
  $scope.closeModal = function() {
	$scope.items = [];
